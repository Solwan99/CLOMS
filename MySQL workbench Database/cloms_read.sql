...
CREATE TABLE `read` (
  ...
  PRIMARY KEY (`VisitorId`,`BookNumber`),
  KEY `BookNumber_idx` (`BookNumber`),
  CONSTRAINT `BookNumberr` FOREIGN KEY (`BookNumber`) REFERENCES `booksandresources` (`BR_NUM`),
  CONSTRAINT `VisitorId` FOREIGN KEY (`VisitorId`) REFERENCES `visitor` (`V_ID`)
